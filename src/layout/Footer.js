...
import { FaInstagram, FaLinkedinIn, FaPinterest, FaYoutube } from 'react-icons/fa';
...
const Footer = () => {
	const linksArr1 = [
		...
		{ name: 'Honeymoon packages - India', link: '/packages/honeymoon-india' },
		{ name: 'Honeymoon packages - Intl.', link: '/packages/honeymoon-international' },
	...
	const linksArr4 = [
		...
		{ name: 'Uttarakhand tour packages', link: '/packages/domestic/uttarakhand' },
		{ name: 'Rajasthan tour packages', link: '/packages/domestic/rajasthan' },
	...
	const linksArr5 = [
		...
		{ name: 'Sri Lanka tour packages', link: '/packages/international/srilanka' },
		{ name: 'Bhutan tour packages', link: '/packages/international/bhutan' },
		{ name: 'Mauritius tour packages', link: '/packages/international/mauritius' },
		{ name: 'Singapore packages', link: '/packages/international/singapore' },
		{ name: 'Maldives packages', link: '/packages/international/maldives' },
		{ name: 'Thailand tour packages', link: '/packages/international/thailand' },
		{ name: 'Indonesia', link: '/packages/international/indonesia' },
		{ name: 'Switzerland tour packages', link: '/packages/international/switzerland' },
		{ name: 'Bangkok tour packages', link: '/packages/international/bangkok' },
		{ name: 'Australia tour packages', link: '/packages/international/australia' },
		{ name: 'USA tour packages', link: '/packages/international/usa' },
		{ name: 'Europe tour packages', link: '/packages/international/europe' },
	];
	...
	const socialLinks = [
		...
		{
			name: 'Instagram',
			icon: <FaInstagram className='bg-gradient-to-br from-[#8a3ab9] to-[#bc2a8d] rounded-full text-xl p-[0.1rem]' />,
			link: 'https://www.instagram.com/',
		},
		{
			name: 'YouTube',
			icon: <FaYoutube className='bg-red-600 rounded-full text-xl p-[0.1rem]' />,
			link: 'https://www.youtube.com/',
		},
		{
			name: 'LinkedIn',
			icon: <FaLinkedinIn className='bg-blue-800 rounded-full text-xl p-[0.1rem]' />,
			link: 'https://www.linkedin.com.com/',
		},
		{
			name: 'Pinterest',
			icon: <FaPinterest className='bg-white text-[#E60023] rounded-full text-xl p-[0rem]' />,
